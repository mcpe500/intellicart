...
// Register the route with authentication middleware and controller method
authRoutes.openapi(getCurrentUserRoute, verifyToken, AuthController.getCurrentUser);
