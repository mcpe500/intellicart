...
describe("Complete Order Management Flow E2E Tests", () => {
  ...
  it("should complete the full order management flow: create product -> create order -> get orders -> update order status", async () => {
    ...
    const getOrdersBody: any = await getOrdersResponse.json();
    ...
    const createdOrder: any = await db.create("orders", orderData);
    ...
    const getOrdersBody2: any = await getOrdersResponse2.json();
    ...
    const updateStatusBody: any = await updateStatusResponse.json();
  ...
  it("should fail to update order status for order that does not belong to user", async () => {
    ...
    const testOrder: any = await db.create("orders", orderData);
